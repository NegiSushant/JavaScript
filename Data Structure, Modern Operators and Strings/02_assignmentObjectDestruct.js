...
console.log(`title: ${title}, author: ${author}, ISBN: ${ISBN}`); //title: Algorithms, author: Robert Sedgewick,Kevin Wayne, ISBN: 9780321573513
...
console.log(`tags: ${tags}`); //['computer science', 'programming', 'algorithms', 'data structures', 'java', 'math', 'software', 'engineering']
...
console.log(
  `language: ${language} and programmingLanguage: ${programmingLanguage}`
); // language: English and programmingLanguage: unknown
...
console.log(`bookTitle: ${bookTitle}, bookAuthor: ${bookAuthor}`); // bookTitle: Algorithms, bookAuthor: Robert Sedgewick,Kevin Wayne
...
console.log(`rating: ${bookRating}`); //rating: 4.41
...
//   console.log(`${obj.title} by ${obj.author}, ${obj.year}`);
// }
